...
def doc_2_virat():
    ...
    Address: 2 cricket blvd, New Dehli 
...
def test_get_address(doc_1_maria, doc_2_virat, doc_3_empty):
    ...
    assert doc_2_virat.get_field('patient_address') == '2 cricket blvd, New Dehli'
    assert doc_3_empty.get_field('patient_name') == None

def test_get_medicines(doc_1_maria, doc_2_virat, doc_3_empty):
    assert doc_2_virat.get_field('medicines') == 'Omprazole 40 mg'
...
def test_parse(doc_1_maria, doc_2_virat, doc_3_empty):
    ...
    assert record_virat == {
        ...
        'patient_address': '2 cricket blvd, New Dehli',
        'medicines': 'Omprazole 40 mg',
        'directions': 'Use two tablets daily for three months',
        'refill': '3'
    }
