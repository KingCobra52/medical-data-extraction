#file responsible for extracting the data
...
def extract(file_path, file_format):
    ...
    if len(pages) > 0:
        page = pages[0]
        processed_image = util.preprocess_image(page) #call function from util
    ...
    if file_format == 'prescription':
        ...
        extracted_data = PatientDetailsParser(document_text).parse_own()
    else:
